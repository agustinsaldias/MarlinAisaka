 ...
 */
  ...
  #define WATCH_BED_TEMP_INCREASE               15 // Degrees Celsius
#endif
...
#define HOMING_BUMP_MM      { 2, 2, 4 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
 ...
 */
  ...
  #define PROBE_PT_1 { 25, 25 }   // (mm) { x, y }
  #define PROBE_PT_2 { 190, 25 }
  #define PROBE_PT_3 { 105, 190 }
#endif
...
//#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_2_DESC "Enable Cold Extrusion"
  #define MAIN_MENU_ITEM_2_GCODE "M302 P1"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Disable Cold Extrusion"
  #define MAIN_MENU_ITEM_3_GCODE "M302 P0"
